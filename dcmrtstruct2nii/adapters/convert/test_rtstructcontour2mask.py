...
from dcmrtstruct2nii.adapters.convert.rtstructcontour2mask import _get_transform_matrix, _transform_physical_point_to_continuous_index
import numpy as np
def rand():
    return random.randint(1,100)/11

class TestRTStructcontour2mask(unittest.TestCase):
    def test__get_transform_matrix(self):
